...
class InvalidPdfTest {
    ...
    void processFiles(List<Path> filesForProcessing) {
        ...
        assertThat("First invalid file is 'TSTPB1-20181123-003.pdf'",
                testMethodState.sipProcessingState.invalidFiles.get(0).fileName.toString(), is("TSTPB1-20181123-003.pdf"))
        assertThat("Second invalid file is 'TSTPB1-20181123-006.pdf'",
                testMethodState.sipProcessingState.invalidFiles.get(1).fileName.toString(), is("TSTPB1-20181123-006.pdf"))
        assertThat("Third invalid file is 'TSTPB1-20181123-009.pdf'",
                testMethodState.sipProcessingState.invalidFiles.get(2).fileName.toString(), is("TSTPB1-20181123-009.pdf"))

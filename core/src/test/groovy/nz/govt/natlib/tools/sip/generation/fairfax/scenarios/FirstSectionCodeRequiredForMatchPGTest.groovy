...
/**
 * Tests the {@code first-section-code-match-parent-grouping} scenario.
 *
...
@Log4j2
class FirstSectionCodeRequiredForMatchPGTest {
    ...
    static final String RESOURCES_FOLDER = "ingestion-files-tests/scenario-first-section-code-match-parent-grouping"
    ...
    void correctlyAssembleSipFromFilesOnFilesystem() {
        ...
        TestHelper.initializeTestMethod(testMethodState, "FirstSectionCodeRequiredForMatchPGTest-", forLocalFilesystem)
    ...
    void processFiles(List<File> filesForProcessing) {
        ...
        List<FairfaxProcessingParameters> parametersList = FairfaxProcessingParameters.build("TST",
                ...
                processingDate, testMethodState.fairfaxSpreadsheet)
    ...
    void sipConstructedCorrectly(String sipXml) {
        ...
        TestHelper.assertExpectedSipFileValues(sipForValidation, 4, "TSTZOO-20181123-001.pdf", "TSTZOO-20181123-001.pdf",
                739L, "MD5", "b5808604069f9f61d94e0660409616ba", "0004", "application/pdf")

        TestHelper.assertExpectedSipFileValues(sipForValidation, 5, "TSTZOO-20181123-002.pdf", "TSTZOO-20181123-002.pdf",
                739L, "MD5", "b5808604069f9f61d94e0660409616ba", "0005", "application/pdf")

        TestHelper.assertExpectedSipFileValues(sipForValidation, 6, "TSTZOO-20181123-003.pdf", "TSTZOO-20181123-003.pdf",
                739L, "MD5", "b5808604069f9f61d94e0660409616ba", "0006", "application/pdf")

        TestHelper.assertExpectedSipFileValues(sipForValidation, 7, "TSTZOO-20181123-004.pdf", "TSTZOO-20181123-004.pdf",
